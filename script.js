...
// 3. Create Particles for Hero Section
...
// 5. Download Modal Logic (Integrated with Validation)
function initDownloadModal() {
    ...
    if (mobileInput) {
        // Keyboard khulte hi form upar lane ke liye
    ...
    // --- Form Submit Handler (Validation + Google Sheet) ---
...
// 6. Hero Background Slider Logic
